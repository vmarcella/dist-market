var HashnodeCrowdsale = artifacts.require("MarketCrowdsale");
var HashnodeToken = artifacts.require("MarketToken");
  ...
  it("should transfer the ETH to wallet immediately in Pre ICO", function(done) {
    HashnodeCrowdsale.deployed().then(async function(instance) {
      ...
      assert.equal(
        ...
        balanceOfBeneficiary + 2000000000000000000,
        "ETH couldn't be transferred to the beneficiary"
      );
      done();
    });
  });
